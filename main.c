...
TaskHandle_t  led2_toggle_task_handle;   /**< Reference to LED0 toggling FreeRTOS task. */
...
int main(void)
{
    ...
    UNUSED_VARIABLE(xTaskCreate(led2_toggle_task_function, "LED2", configMINIMAL_STACK_SIZE + 200, NULL, 2, &led2_toggle_task_handle));
